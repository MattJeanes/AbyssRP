...
surface.CreateFont("ScoreboardHead", {size=32, weight=800})
surface.CreateFont("ScoreboardSub", {size=26, weight=800})
surface.CreateFont("ScoreboardText", {font="Verdana Bold", size=18})
...
function GM:HUDDrawScoreBoard()
	...
	for team,info in pairs(ScoreboardInfo) do
		local plys="Players"
		if #info.Players==1 then
			plys="Player"
		end
		local teamText = info.TeamName .. "  (" .. #info.Players .. " "..plys..")"

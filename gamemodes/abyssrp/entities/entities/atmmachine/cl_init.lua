...
local function BankMenu()
	...
	DLabel1:SetText("Welcome to your bank account, Please enter the values below on how much you want to withdraw or deposit. You have $"..LocalPlayer():GetNWInt("bank").." in your bank account.")

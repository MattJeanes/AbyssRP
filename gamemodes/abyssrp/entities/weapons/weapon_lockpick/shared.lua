...
function SWEP:PrimaryAttack()
	...
	if IsValid(e) and trace.HitPos:Distance(self.Owner:GetShootPos()) <= 100 and ((e:IsDoor() and e:Owned()) or e:IsVehicle() or string.find(string.lower(e:GetClass()), "vehicle") or e.isFadingDoor) then

...
function SWEP:PrimaryAttack()
	...
	timer.Simple(3, function()
		if (not self.Owner or not self.Owner:Alive() or self.Weapon:GetOwner():GetActiveWeapon():GetClass() ~= "weapon_rp_c4" or not IsFirstTimePredicted()) then return end
		...
		timer.Simple(0.6, function()
			if (not self.Owner:Alive() or self.Weapon:GetOwner():GetActiveWeapon():GetClass() ~= "weapon_rp_c4") or not IsFirstTimePredicted() then return end
